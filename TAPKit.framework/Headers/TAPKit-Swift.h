...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull controller;)
+ (NSString * _Nonnull)controller SWIFT_WARN_UNUSED_RESULT;
...
- (void)setDefaultTAPInputMode:(NSString * _Nonnull)defaultMode immediate:(BOOL)immediate;
- (void)setTAPInputMode:(NSString * _Nonnull)newMode forIdentifiers:(NSArray<NSString *> * _Nullable)identifiers;
- (NSDictionary<NSString *, NSString *> * _Nonnull)getConnectedTaps SWIFT_WARN_UNUSED_RESULT;
- (NSString * _Nullable)getTAPInputModeForTapIdentifier:(NSString * _Nonnull)identifier SWIFT_WARN_UNUSED_RESULT;
@end
...
- (void)tapConnectedWithIdentifier:(NSString * _Nonnull)identifier name:(NSString * _Nonnull)name;
...
- (void)tappedWithIdentifier:(NSString * _Nonnull)identifier combination:(uint8_t)combination;
